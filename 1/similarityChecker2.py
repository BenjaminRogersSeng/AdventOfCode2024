...
def calculate_occurrences(array1, array2, occurrenceMatrix):
    for i in range(len(array1)):
        occurrenceMatrix.append(array2.count(array1[i]))
...
if __name__ == "__main__":
    ...
    print(calculate_occurrences(array1, array2, occurrenceMatrix))
    print(calculated_similarity(array1, occurrenceMatrix))